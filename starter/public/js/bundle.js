...
var stripe = Stripe("pk_test_51I2iCfCF0ORVdl7FpJRrSls1v2GXpAmDDMmwvE1neD5dhmjd8bFkudRTDaxTDtOszKJEo7C3vgvIeMbGsOYOzLns00NSR68oCP");
...
(0, _stripe.bookTour)("5c88fa8cf4afda39709c295a");
console.log("Hello from the javascript from client side");
var mapBox = document.getElementById("map");
var loginForm = document.querySelector(".form--login");
var logOutBtn = document.querySelector(".nav__el--logout");
var userDataForm = document.querySelector(".form-user-data");
var userPasswordForm = document.querySelector(".form-user-password"); // const bookBtn=document.getElementById("book-tour");
...
if (loginForm) loginForm.addEventListener("submit", function (e) {
  console.log("inside login form function");
  e.preventDefault();
